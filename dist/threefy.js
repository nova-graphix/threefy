...
import * as Vt from "three/addons/utils/SkeletonUtils";
import { EffectComposer as nt } from "three/addons/postprocessing/EffectComposer";
import { EffectComposer as Jn } from "three/addons/postprocessing/EffectComposer";
import { RGBELoader as ot } from "three/addons/loaders/RGBELoader";
import { RGBELoader as qn } from "three/addons/loaders/RGBELoader";
import { ArcballControls as zt } from "three/addons/controls/ArcballControls";
import { ArcballControls as Qn } from "three/addons/controls/ArcballControls";
import { DragControls as it } from "three/addons/controls/DragControls";
import { DragControls as to } from "three/addons/controls/DragControls";
import { FirstPersonControls as at } from "three/addons/controls/FirstPersonControls";
import { FirstPersonControls as so } from "three/addons/controls/FirstPersonControls";
import { FlyControls as Nt } from "three/addons/controls/FlyControls";
import { FlyControls as oo } from "three/addons/controls/FlyControls";
import { MapControls as Ht } from "three/addons/controls/MapControls";
import { MapControls as ao } from "three/addons/controls/MapControls";
import { OrbitControls as ct } from "three/addons/controls/OrbitControls";
import { OrbitControls as lo } from "three/addons/controls/OrbitControls";
import { PointerLockControls as K } from "three/addons/controls/PointerLockControls";
import { PointerLockControls as ho } from "three/addons/controls/PointerLockControls";
import { TrackballControls as lt } from "three/addons/controls/TrackballControls";
import { TrackballControls as po } from "three/addons/controls/TrackballControls";
import { TransformControls as ye } from "three/addons/controls/TransformControls";
import { TransformControls as go } from "three/addons/controls/TransformControls";
import { DotScreenShader as Kt } from "three/addons/shaders/DotScreenShader";
import { DotScreenShader as vo } from "three/addons/shaders/DotScreenShader";
import { RGBShiftShader as Wt } from "three/addons/shaders/RGBShiftShader";
import { RGBShiftShader as wo } from "three/addons/shaders/RGBShiftShader";
import { FXAAShader as Xt } from "three/addons/shaders/FXAAShader";
import { FXAAShader as Mo } from "three/addons/shaders/FXAAShader";
import { RenderPass as be } from "three/addons/postprocessing/RenderPass";
import { RenderPass as To } from "three/addons/postprocessing/RenderPass";
import { ShaderPass as Jt } from "three/addons/postprocessing/ShaderPass";
import { ShaderPass as Lo } from "three/addons/postprocessing/ShaderPass";
import { GlitchPass as Yt } from "three/addons/postprocessing/GlitchPass";
import { GlitchPass as ko } from "three/addons/postprocessing/GlitchPass";
import { GTAOPass as qt } from "three/addons/postprocessing/GTAOPass";
import { GTAOPass as _o } from "three/addons/postprocessing/GTAOPass";
import { OutlinePass as ut } from "three/addons/postprocessing/OutlinePass";
import { OutlinePass as Do } from "three/addons/postprocessing/OutlinePass";
import { UnrealBloomPass as Zt } from "three/addons/postprocessing/UnrealBloomPass";
import { UnrealBloomPass as Ro } from "three/addons/postprocessing/UnrealBloomPass";
import { Pass as Qt } from "three/addons/postprocessing/Pass";
import { BokehDepthShader as er, BokehShader as tr } from "three/addons/shaders/BokehShader2";
import { OutputPass as dt } from "three/addons/postprocessing/OutputPass";
import { OutputPass as Uo } from "three/addons/postprocessing/OutputPass";
import { AnaglyphEffect as Ee } from "three/addons/effects/AnaglyphEffect";
import { AnaglyphEffect as Go } from "three/addons/effects/AnaglyphEffect";
import { AsciiEffect as Le } from "three/addons/effects/AsciiEffect";
import { AsciiEffect as Fo } from "three/addons/effects/AsciiEffect";
import { OutlineEffect as Se } from "three/addons/effects/OutlineEffect";
import { OutlineEffect as Vo } from "three/addons/effects/OutlineEffect";
import { ParallaxBarrierEffect as ke } from "three/addons/effects/ParallaxBarrierEffect";
import { ParallaxBarrierEffect as No } from "three/addons/effects/ParallaxBarrierEffect";
import { PeppersGhostEffect as Ae } from "three/addons/effects/PeppersGhostEffect";
import { PeppersGhostEffect as Ko } from "three/addons/effects/PeppersGhostEffect";
import { StereoEffect as _e } from "three/addons/effects/StereoEffect";
import { StereoEffect as Xo } from "three/addons/effects/StereoEffect";
import { RoundedBoxGeometry as Pe } from "three/addons/geometries/RoundedBoxGeometry";
import { RoundedBoxGeometry as Yo } from "three/addons/geometries/RoundedBoxGeometry";
import { ConvexGeometry as De } from "three/addons/geometries/ConvexGeometry";
import { ConvexGeometry as Zo } from "three/addons/geometries/ConvexGeometry";
import { DecalGeometry as Oe } from "three/addons/geometries/DecalGeometry";
import { DecalGeometry as ei } from "three/addons/geometries/DecalGeometry";
import { ParametricGeometry as Re } from "three/addons/geometries/ParametricGeometry";
import { ParametricGeometry as ri } from "three/addons/geometries/ParametricGeometry";
import { TextGeometry as ht } from "three/addons/geometries/TextGeometry";
import { TextGeometry as ni } from "three/addons/geometries/TextGeometry";
import { FontLoader as rr } from "three/addons/loaders/FontLoader";
import { FontLoader as ii } from "three/addons/loaders/FontLoader";
import { NURBSCurve as ft } from "three/addons/curves/NURBSCurve";
import { NURBSCurve as ci } from "three/addons/curves/NURBSCurve";
import { NURBSSurface as pt } from "three/addons/curves/NURBSSurface";
import { NURBSSurface as ui } from "three/addons/curves/NURBSSurface";
import { LightProbeGenerator as sr } from "three/addons/lights/LightProbeGenerator";
import { LightProbeGenerator as hi } from "three/addons/lights/LightProbeGenerator";
import { RectAreaLightHelper as nr } from "three/addons/helpers/RectAreaLightHelper";
import { RectAreaLightHelper as pi } from "three/addons/helpers/RectAreaLightHelper";
import { RectAreaLightUniformsLib as or } from "three/addons/lights/RectAreaLightUniformsLib";
import { RectAreaLightUniformsLib as gi } from "three/addons/lights/RectAreaLightUniformsLib";
import { VertexNormalsHelper as ir } from "three/addons/helpers/VertexNormalsHelper";
import { VertexNormalsHelper as vi } from "three/addons/helpers/VertexNormalsHelper";
import { VertexTangentsHelper as ar } from "three/addons/helpers/VertexTangentsHelper";
import { VertexTangentsHelper as wi } from "three/addons/helpers/VertexTangentsHelper";
import { GLTFExporter as je } from "three/addons/exporters/GLTFExporter";
import { OBJExporter as cr } from "three/addons/exporters/OBJExporter";
import { PLYExporter as lr } from "three/addons/exporters/PLYExporter";
import { STLExporter as ur } from "three/addons/exporters/STLExporter";
import { VTKLoader as dr } from "three/addons/loaders/VTKLoader";
import { MD2Loader as hr } from "three/addons/loaders/MD2Loader";
import { FBXLoader as fr } from "three/addons/loaders/FBXLoader";
import { VRMLLoader as pr } from "three/addons/loaders/VRMLLoader";
import { AMFLoader as mr } from "three/addons/loaders/AMFLoader";
import { ThreeMFLoader as gr } from "three/addons/loaders/3MFLoader";
import { ColladaLoader as yr } from "three/addons/loaders/ColladaLoader";
import { PLYLoader as vr } from "three/addons/loaders/PLYLoader";
import { STLLoader as xr } from "three/addons/loaders/STLLoader";
import { OBJLoader as wr } from "three/addons/loaders/OBJLoader";
import { MTLLoader as br } from "three/addons/loaders/MTLLoader";
import { SVGLoader as Mr } from "three/addons/loaders/SVGLoader";
import { KMZLoader as Cr } from "three/addons/loaders/KMZLoader";
import { TDSLoader as Tr } from "three/addons/loaders/TDSLoader";
import { GLTFLoader as Er } from "three/addons/loaders/GLTFLoader";
import { KTX2Loader as Lr } from "three/addons/loaders/KTX2Loader";
import { DRACOLoader as Ve } from "three/addons/loaders/DRACOLoader";
import { MeshoptDecoder as Sr } from "three/addons/libs/meshopt_decoder.module";
import { VOXLoader as kr, VOXMesh as Ar } from "three/addons/loaders/VOXLoader";
import { unzipSync as mt, strFromU8 as _r } from "three/addons/libs/fflate.module";
import { mergeGeometries as Pr } from "three/addons/utils/BufferGeometryUtils";
const ze = function(r) {
  if (!r) {
